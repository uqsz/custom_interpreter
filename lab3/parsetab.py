...
_lr_productions = [
  ...
  ('operation -> operation PLUS operation','operation',3,'p_operation','Mparser.py',92),
  ('operation -> operation MINUS operation','operation',3,'p_operation','Mparser.py',93),
  ('operation -> operation TIMES operation','operation',3,'p_operation','Mparser.py',94),
  ('operation -> operation DIVIDE operation','operation',3,'p_operation','Mparser.py',95),
  ('operation -> operation DOTADD operation','operation',3,'p_operation','Mparser.py',96),
  ('operation -> operation DOTSUB operation','operation',3,'p_operation','Mparser.py',97),
  ('operation -> operation DOTMUL operation','operation',3,'p_operation','Mparser.py',98),
  ('operation -> operation DOTDIV operation','operation',3,'p_operation','Mparser.py',99),
  ('operation -> MINUS operation','operation',2,'p_operation','Mparser.py',100),
  ('operation -> operation TRANSPOSE','operation',2,'p_operation','Mparser.py',101),
  ('operation -> EYE LPAREN operation RPAREN','operation',4,'p_operation','Mparser.py',102),
  ('operation -> ZEROS LPAREN operation RPAREN','operation',4,'p_operation','Mparser.py',103),
  ('operation -> ONES LPAREN operation RPAREN','operation',4,'p_operation','Mparser.py',104),
