...
_lr_productions = [
  ...
  ('instruction -> LCURLY expression RCURLY','instruction',3,'p_instruction','Mparser.py',31),
  ('instruction -> line SEMICOLON','instruction',2,'p_instruction','Mparser.py',32),
  ('instruction -> for_state','instruction',1,'p_instruction','Mparser.py',33),
  ('instruction -> ifelse_state','instruction',1,'p_instruction','Mparser.py',34),
  ('instruction -> while_state','instruction',1,'p_instruction','Mparser.py',35),
  ('line -> assign','line',1,'p_line','Mparser.py',39),
  ('line -> PRINT print_state','line',2,'p_line','Mparser.py',40),
  ('line -> BREAK','line',1,'p_line','Mparser.py',41),
  ('line -> CONTINUE','line',1,'p_line','Mparser.py',42),
  ('line -> RETURN print_state','line',2,'p_line','Mparser.py',43),
  ('line -> RETURN','line',1,'p_line','Mparser.py',44),
  ('print_state -> printable COMMA print_state','print_state',3,'p_print_state','Mparser.py',48),
  ('print_state -> printable','print_state',1,'p_print_state','Mparser.py',49),
  ('printable -> operation','printable',1,'p_printable','Mparser.py',53),
  ('printable -> STRING','printable',1,'p_printable','Mparser.py',54),
  ('assign -> object ASSIGN operation','assign',3,'p_assign','Mparser.py',58),
  ('assign -> object ADDASSIGN operation','assign',3,'p_assign','Mparser.py',59),
  ('assign -> object SUBASSIGN operation','assign',3,'p_assign','Mparser.py',60),
  ('assign -> object MULASSIGN operation','assign',3,'p_assign','Mparser.py',61),
  ('assign -> object DIVASSIGN operation','assign',3,'p_assign','Mparser.py',62),
  ('operation -> operation PLUS operation','operation',3,'p_operation','Mparser.py',66),
  ('operation -> operation MINUS operation','operation',3,'p_operation','Mparser.py',67),
  ('operation -> operation TIMES operation','operation',3,'p_operation','Mparser.py',68),
  ('operation -> operation DIVIDE operation','operation',3,'p_operation','Mparser.py',69),
  ('operation -> operation DOTADD operation','operation',3,'p_operation','Mparser.py',70),
  ('operation -> operation DOTSUB operation','operation',3,'p_operation','Mparser.py',71),
  ('operation -> operation DOTMUL operation','operation',3,'p_operation','Mparser.py',72),
  ('operation -> operation DOTDIV operation','operation',3,'p_operation','Mparser.py',73),
  ('operation -> MINUS operation','operation',2,'p_operation','Mparser.py',74),
  ('operation -> operation TRANSPOSE','operation',2,'p_operation','Mparser.py',75),
  ('operation -> EYE LPAREN operation RPAREN','operation',4,'p_operation','Mparser.py',76),
  ('operation -> ZEROS LPAREN operation RPAREN','operation',4,'p_operation','Mparser.py',77),
  ('operation -> ONES LPAREN operation RPAREN','operation',4,'p_operation','Mparser.py',78),
  ('operation -> object','operation',1,'p_operation','Mparser.py',79),
  ('operation -> number','operation',1,'p_operation','Mparser.py',80),
  ('operation -> matrix','operation',1,'p_operation','Mparser.py',81),
  ('bool -> LPAREN bool RPAREN','bool',3,'p_bool','Mparser.py',85),
  ('bool -> operation MORE operation','bool',3,'p_bool','Mparser.py',86),
  ('bool -> operation LESS operation','bool',3,'p_bool','Mparser.py',87),
  ('bool -> operation MOREOREQ operation','bool',3,'p_bool','Mparser.py',88),
  ('bool -> operation LESSOREQ operation','bool',3,'p_bool','Mparser.py',89),
  ('bool -> operation EQUALS operation','bool',3,'p_bool','Mparser.py',90),
  ('bool -> operation NOTEQUALS operation','bool',3,'p_bool','Mparser.py',91),
  ('object -> ID vector','object',2,'p_object','Mparser.py',95),
  ('object -> ID','object',1,'p_object','Mparser.py',96),
  ('ifelse_state -> IF LPAREN bool RPAREN instruction','ifelse_state',5,'p_ifelse_state','Mparser.py',100),
  ('ifelse_state -> IF LPAREN bool RPAREN instruction ELSE instruction','ifelse_state',7,'p_ifelse_state','Mparser.py',101),
  ('while_state -> WHILE LPAREN bool RPAREN instruction','while_state',5,'p_while_state','Mparser.py',105),
  ('for_state -> FOR ID ASSIGN forable COLON forable instruction','for_state',7,'p_for_state','Mparser.py',109),
  ('forable -> object','forable',1,'p_forable','Mparser.py',113),
  ('forable -> INT','forable',1,'p_forable','Mparser.py',114),
  ('matrix -> LSQUAR row RSQUAR','matrix',3,'p_matrix','Mparser.py',118),
  ('row -> row COMMA vector','row',3,'p_row','Mparser.py',122),
  ('row -> vector','row',1,'p_row','Mparser.py',123),
  ('vector -> LSQUAR elem RSQUAR','vector',3,'p_vector','Mparser.py',127),
  ('elem -> elem COMMA number','elem',3,'p_elem','Mparser.py',131),
  ('elem -> number','elem',1,'p_elem','Mparser.py',132),
  ('number -> INT','number',1,'p_number','Mparser.py',136),
  ('number -> FLOAT','number',1,'p_number','Mparser.py',137),
]
