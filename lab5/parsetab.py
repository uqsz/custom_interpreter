...
_lr_productions = [
  ...
  ('expression -> expression instruction','expression',2,'p_expression','Mparser.py',27),
  ('expression -> instruction','expression',1,'p_expression','Mparser.py',28),
  ('instruction -> LCURLY expression RCURLY','instruction',3,'p_instruction','Mparser.py',37),
  ('instruction -> line SEMICOLON','instruction',2,'p_instruction','Mparser.py',38),
  ('instruction -> for_state','instruction',1,'p_instruction','Mparser.py',39),
  ('instruction -> ifelse_state','instruction',1,'p_instruction','Mparser.py',40),
  ('instruction -> while_state','instruction',1,'p_instruction','Mparser.py',41),
  ('line -> assign','line',1,'p_line','Mparser.py',49),
  ('line -> PRINT print_state','line',2,'p_line','Mparser.py',50),
  ('line -> BREAK','line',1,'p_line','Mparser.py',51),
  ('line -> CONTINUE','line',1,'p_line','Mparser.py',52),
  ('line -> RETURN print_state','line',2,'p_line','Mparser.py',53),
  ('line -> RETURN','line',1,'p_line','Mparser.py',54),
  ('print_state -> printable COMMA print_state','print_state',3,'p_print_state','Mparser.py',66),
  ('print_state -> printable','print_state',1,'p_print_state','Mparser.py',67),
  ('printable -> operation','printable',1,'p_printable','Mparser.py',75),
  ('printable -> STRING','printable',1,'p_printable','Mparser.py',76),
  ('assign -> object ASSIGN operation','assign',3,'p_assign','Mparser.py',84),
  ('assign -> object ADDASSIGN operation','assign',3,'p_assign','Mparser.py',85),
  ('assign -> object SUBASSIGN operation','assign',3,'p_assign','Mparser.py',86),
  ('assign -> object MULASSIGN operation','assign',3,'p_assign','Mparser.py',87),
  ('assign -> object DIVASSIGN operation','assign',3,'p_assign','Mparser.py',88),
